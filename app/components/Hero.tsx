  ...
  return (
    <div className="bg-dark-gray">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="w-full mx-auto py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          </div>
          <div className="text-center">
            <h1 className="text-4xl text-light font-sans-serif tracking-tight sm:text-6xl">
              Liz Tiller
            </h1>
            <p className="text-light lg:text-2xl font-serif-regular font-bold pt-6">
